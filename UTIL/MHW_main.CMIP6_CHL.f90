...
!------------------------------------------------------------------------------!
        PROGRAM MHWs_main
            ...
            model      =  "model_name"
            dir_name   =  "DATA/CMIP6_hist_CHL_regrid"
            tmp1       =  "regrid_360x180_chlos_Oday_"
            ...
            file_name  =  TRIM(model)//"_win_11_daily_chl_anom."//           &
            ...
            file_name  =  TRIM(model)//"_win_11_daily_chl_clim."//           &
                          TRIM(char_str)//"-"//TRIM(char_end)//".nc"
            var_name   =  "chl_clim"
